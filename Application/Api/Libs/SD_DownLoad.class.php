...
class SD_DownLoad 
{
    ...
    /**
        ...
        * @return void
        **/
    public function Down($pFilePath,$downstart = 0, $pFileName = '') {
...
//          $this->Send();
    ...
    /**
        ...
        * @return void
        **/
    private function SetStart($downstart) {
         if (!empty($downstart)) {
              	$this->mDownStart = $downstart;
	        	 fseek($this->mFileHandle, $this->mDownStart,$this->mDownStart+1024);
	        	 var_dump(fseek($this->mFileHandle, $this->mDownStart,$this->mDownStart+1024));
	        	 exit();
	        	 $content	=	fread($this->mFileHandle);
	        	 var_dump($content);
	        	 exit();
